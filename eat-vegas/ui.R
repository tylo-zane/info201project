...
shinyUI(fluidPage(theme = shinytheme("darkly"),
  ...
  sidebarLayout(
    position = "left",
    sidebarPanel(
      # LOGO of the app, should be included in "eat-vegas" folder
      img(src='eatLasVegas.png', align = "center", width = "125%"), 
      selectInput("cuisine",
                  "Select a category of cuisine:",
                  list("All","American", "Italian", "French", "Japanese", 
                       "Chinese", "Indian", "Mexican", "Vegetarian",
                       "Hawaiian", "Food Truck", "Steakhouses", "Desserts", 
                       "Seafood", "Greek", "Bars", "Breakfast & Brunch")),
